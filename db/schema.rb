...
ActiveRecord::Schema.define(version: 2021_02_07_082714) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["deals_id"], name: "index_addresses_on_deals_id"
  end
  ...
  add_foreign_key "addresses", "deals", column: "deals_id"
